...
def run(
    ...
    im = torch.zeros(batch_size, imgchnl, *imgsz).to(device)  # image size(1,3,320,192) BCHW iDetection
...
def parse_opt(known=False):
    ...
    parser.add_argument('--imgchnl', type=int, default=3, help='image channels')
